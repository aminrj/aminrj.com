...
```
![Pods in the observability namespace](assets/observability-pods.png)
...
![Pods in the kafka namespace](assets/kafka-ns-pods.png)
...
![Grafana Dashboard for Strimzi Kafka](assets/strimzi-monitoring-grafana-dashboard.png)
